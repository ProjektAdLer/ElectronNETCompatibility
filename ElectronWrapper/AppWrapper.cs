...
namespace ElectronWrapper
{
    ...
    class AppWrapper : IAppWrapper
    {
        ...
        public event Action BrowserWindowCreated
        {
            add
            {
                app.BrowserWindowCreated += value;
            }
        ...
        public event Action<bool> AccessibilitySupportChanged
        {
            add
            {
                app.AccessibilitySupportChanged += value;
            }
            remove
            {
                app.AccessibilitySupportChanged -= value;
        ...
        /// </summary>
        public CommandLine CommandLine { get { return app.CommandLine; } }
        ...
        public Task<string> UserAgentFallbackAsync
        {
            get
            {
                return app.UserAgentFallbackAsync;
            }
        }
