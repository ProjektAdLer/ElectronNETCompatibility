...
namespace ElectronWrapper
{
    ...
    class AutoUpdaterWrapper : IAutoUpdaterWrapper
    {
        ...
        public bool FullChangelog
        {
            get
            {
                return autoUpdater.FullChangelog;
            }
            set
            {
        ...
        public Task<SemVer> CurrentVersionAsync
        {
            get
            {
                return autoUpdater.CurrentVersionAsync;
            }
        }
        ...
        public Task<string> ChannelAsync
        {
            get
            {
                return autoUpdater.ChannelAsync;
            }
        }
        ...
        public Task<Dictionary<string, string>> RequestHeadersAsync
        {
            get
            {
                return autoUpdater.RequestHeadersAsync;
            }
        }
        ...
        public event Action OnCheckingForUpdate
        {
            add
            {
                autoUpdater.OnCheckingForUpdate += value;
            }
            remove
            {
                autoUpdater.OnCheckingForUpdate -= value;
        ...
        public event Action<UpdateInfo> OnUpdateAvailable
        {
            add
            {
                autoUpdater.OnUpdateAvailable += value;
            }
            remove
            {
                autoUpdater.OnUpdateAvailable -= value;
        ...
        public event Action<UpdateInfo> OnUpdateNotAvailable
        {
            add
            {
                autoUpdater.OnUpdateNotAvailable += value;
            }
            remove
            {
                autoUpdater.OnUpdateNotAvailable -= value;
        ...
        public event Action<ProgressInfo> OnDownloadProgress
        {
            add
            {
                autoUpdater.OnDownloadProgress += value;
            }
            remove
            {
                autoUpdater.OnDownloadProgress -= value;
        ...
        public event Action<UpdateInfo> OnUpdateDownloaded
        {
            add
            {
                autoUpdater.OnUpdateDownloaded += value;
            }
            remove
            {
                autoUpdater.OnUpdateDownloaded -= value;
