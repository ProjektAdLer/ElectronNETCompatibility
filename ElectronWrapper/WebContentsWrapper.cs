...
namespace ElectronWrapper
{
    ...
    class WebContentsWrapper : IWebContentsWrapper
    {
        ...
        /// The identifier.
        /// </value>
        public int Id { get { return webContents.Id; } }

        /// <summary>
        /// Manage browser sessions, cookies, cache, proxy settings, etc.
        /// </summary>
        public Session Session { get { return webContents.Session; } }
        ...
        public event Action OnDidFinishLoad
        {
            add
            {
                webContents.OnDidFinishLoad += value;
            }
            remove
            {
                webContents.OnDidFinishLoad -= value;
